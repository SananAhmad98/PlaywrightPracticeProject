...
//Serial mode can be utilized when there is interdependency among the tests. Hence, if test method fails, then the subsequent test
//methods will be skipped automatically. Default mode does not consider inter-dependency among test methods.
